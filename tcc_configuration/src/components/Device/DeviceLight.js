...
export default function DeviceLight(props) {
    ...
    return (
        <>
            <FormControl>
                ...
                >
                    <MenuItem value={"light.simple"}>Simple</MenuItem>
                    <MenuItem value={"light.simple_profile"}>Simple Profile</MenuItem>
                </Select>
            </FormControl>
            <FormControl>
                <TextField
            ...
            { modelParams["model_type"] === "light.simple_profile"
                ?
                    <FormControl>
